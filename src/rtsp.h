...
namespace rtsp_stream {
  ...
  struct launch_session_t {
    ...
    bool path_preflight_available { false };
    std::string path_preflight_observed_peer_endpoint;
    std::string path_preflight_host_local_endpoint;
    std::uint32_t path_preflight_rtt_ms { 0 };
    std::uint32_t path_preflight_age_ms { 0 };
    ...
    // Tracks which stream types have completed setup.
