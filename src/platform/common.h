...
#undef _CONVERT
  ...
  public:
    ...
    /**
     * @brief Whether Sunshine should restore the sink selected before streaming.
     * @details Platforms may return false after observing an external default
     *          endpoint change that the user asked Sunshine to preserve.
     */
    virtual bool
