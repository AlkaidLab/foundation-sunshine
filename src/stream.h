...
namespace stream {
  ...
  struct session_info_t {
    ...
    uint64_t transport_path_id;
    uint32_t transport_kind;
    uint32_t transport_protocol;
    uint32_t transport_flags;
    uint32_t transport_rtt_us;
    uint32_t transport_jitter_us;
    uint32_t transport_packet_loss_ppm;
    std::string transport_route_id;
    uint32_t pointer_mode;
    uint32_t cursor_state_flags;
    uint32_t pointer_release_queue_depth;
    uint32_t pointer_release_queue_delay_us;
    uint32_t pointer_mode_switch_us;
    uint32_t pointer_deltas_coalesced;
    uint32_t pointer_acceleration_risk_ppm;
    std::string app_name;
    int app_id;
  };
